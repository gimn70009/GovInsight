...
from app.domains.analysis.context.tools import EVIDENCE_COVERAGE_INSTRUCTIONS
from app.domains.analysis.evidence.tools import ANALYSIS_TOOLS, AnalysisToolContext
