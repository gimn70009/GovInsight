...
from app.domains.analysis.evidence import agent as evidence_agent
from app.domains.analysis.evidence import tools
from app.domains.analysis.evidence.agent import AnalysisEvidenceAgent, EvidenceCollectionError
...
from app.domains.analysis.workflow.retry_policy import TIMEOUT_FEEDBACK
from tests.domains.analysis.evidence.fakes import ScriptedEvidenceModel, calls, tool_results
...
def test_outer_timeout_cancels_legal_review_when_final_model_is_pending():
    from tests.domains.analysis.evidence.fakes import collect_all_evidence
