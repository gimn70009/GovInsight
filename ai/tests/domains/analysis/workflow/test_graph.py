...
from app.domains.analysis.workflow.agent import (
    SYSTEM_PROMPT,
    AgentAnalysis,
...
from app.domains.analysis.workflow.graph import (
...
def test_retry_shrinks_sources_and_guides_complete_output_only_for_timeouts(
    ...
    from app.domains.analysis.workflow.retry_policy import COMPACT_RETRY_INSTRUCTIONS
