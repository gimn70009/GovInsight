...
def test_missing_attachment_is_insufficient_without_erasing_restriction():
    from app.domains.analysis.legal_risks import apply_document_coverage, no_candidate_legal_risks
...
def test_model_schema_requires_every_risk_and_rejects_empty_response():
    ...
    from app.domains.analysis.legal_risks import LegalRiskModelResponse
