...
from tests.domains.analysis.proposals.test_language import ENGLISH_BODY
...
def test_metadata_cannot_pad_a_too_short_body_past_the_minimum():
    from app.domains.analysis.proposals.writer import selected_outline
...
def test_generated_model_keeps_short_body_for_local_validation_and_repair():
    from app.domains.analysis.proposals.writer import GeneratedProposal
