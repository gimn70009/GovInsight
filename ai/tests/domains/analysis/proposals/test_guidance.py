...
from tests.domains.analysis.proposals.test_section_contract import slots
...
async def run_public(responses, *, regeneration=False, repeats=1):
    ...
    with (
        ...
        patch("app.domains.analysis.proposals.writer.serialize_company_profile",
...
def test_public_guidance_repair_targets_only_failures_and_preserves_metadata(
    ...
    caplog.set_level(logging.INFO, logger="app.domains.analysis.proposals.writer")
    initial = slots()
